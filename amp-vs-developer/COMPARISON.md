...
- Analyzed: 8 projects with 309 implementation files and 114 test files
- Paired files: 93 (30% of implementation files)
- Unpaired implementation files: 216 (lacking test counterparts)
- Unpaired test files: 21 (without implementation counterparts)

**Symbol-Test Coverage**

- Total exported symbols: 1589
- Covered by tests: 498 symbols
- Uncovered: 1091 symbols
- Average coverage ratio: 31%
...
- Total implementation files: 309
- Total paired: 93 (30% of implementation files)
- Unpaired files/tests: 237
...
- **mig**: 35 files, 3 tests, 3/44 symbols covered (5%)

---

Generated: Fri Dec 12 22:07:06 CET 2025
